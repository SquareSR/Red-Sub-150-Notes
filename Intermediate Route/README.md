...
- 1-11 Potion and use/toss Antidote
...
- Spam Bubble on Onix [1-6 Potion; 1-13 after Screech]
...
- Caterpie: [1-3 Potion]
	- HA x2 (Tackle turn 2 if hit by 2 String Shot before the first HA)
- Metapod:
...
**Moon Manip Save**
- Potion to 36+
- If in red bar (1-8 HP) and confident with yoloball, delay heal until after Paras catch
